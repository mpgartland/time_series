...
NOTE: When you see violation of the 4 moments, you can transform.

The first step to try "normzalize" data is to take the log of it. 

The frist step to try to remove the trend (detrend it) it to take the difference. 
